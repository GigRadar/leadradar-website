...
const SIGNALS = [
  { srcClass: 'tg', text: '#saas-growth  "anyone using Clay alternatives? getting expensive fast"', time: '2s',  persona: 0 },
  { srcClass: 'uw', text: 'Job post: "Build LinkedIn scraper for outbound leads"  $3,200 budget',   time: '5s',  persona: 1 },
  { srcClass: 'rd', text: 'r/sales  "ZoomInfo renewed, feels like robbery — what are you using?"',   time: '9s',  persona: 2 },
  { srcClass: 'li', text: 'liked 3 posts from Gong competitors this week',                           time: '13s', persona: 3 },
  { srcClass: 'uw', text: 'Job post: "Automate outreach for B2B SaaS startup"  $1,800 fixed price',  time: '18s', persona: 4 },
  { srcClass: 'tg', text: '#leadgen  "just hit 50 demos this month using intent signals only"',       time: '22s', persona: 5 },
  { srcClass: 'rd', text: 'r/entrepreneur  "what signal told you a prospect was actually ready?"',    time: '27s', persona: 6 },
  { srcClass: 'dc', text: 'GTM Operators  "clay waterfall is broken again, anyone else?"',            time: '31s', persona: 7 },
  { srcClass: 'li', text: 'switched from Salesforce to Attio · 3 posts about RevOps stack',          time: '36s', persona: 8 },
  { srcClass: 'uw', text: 'Job post: "Scrape Crunchbase for Series A funding leads"  $900 budget',   time: '40s', persona: 9 },
  { srcClass: 'rd', text: 'r/startups  "built a bot monitoring competitor G2 reviews for leads"',    time: '44s', persona: 10 },
  { srcClass: 'uw', text: 'Job post: "Lead enrichment pipeline with Apollo + Clay"  $2,100',         time: '49s', persona: 11 },
  { srcClass: 'li', text: "RSVP'd to SaaStr Annual · following 4 sales intelligence tools",          time: '54s', persona: 12 },
  { srcClass: 'rd', text: 'r/sales  "Apollo data quality dropped this quarter — alternatives?"',     time: '58s', persona: 13 },
  { srcClass: 'tg', text: '#saas-sales  "client asking for intent signals to feed into Instantly"',   time: '63s', persona: 14 },
]
